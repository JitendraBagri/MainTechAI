...
const serviceData = [
  {
    icon: <RxCrop />,
    title: 'Branding',
    description: 'Transforming businesses through innovative branding and AI solutions.',
  },
  {
    icon: <RxPencil2 />,
    title: 'Design',
    description: 'Creating captivating designs that redefine user experiences.',
  },
  {
    icon: <RxDesktop />,
    title: 'Development',
    description: 'Pioneering AI-driven software development for a smarter tomorrow.',
  },
  {
    icon: <RxReader />,
    title: 'Copywriting',
